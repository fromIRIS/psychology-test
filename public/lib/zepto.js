...
var Zepto = function() {
    ...
    var w, x, y, z, A, B, C = [],
        ...
        E = C.filter,
        F = window.document,
        G = {}, H = {}, I = F.defaultView.getComputedStyle,
        J = {
            "column-count": 1,
            columns: 1,
            "font-weight": 1,
    ...
    return Y.matches = function(a, b) {
        ...
        var c, d, e, f = [];
        if (h(a)) for (d = 0; d < a.length; d++) c = b(a[d], d), null != c && f.push(c);
...
function(a) {
    ...
    a.active = 0, a.ajaxJSONP = function(b) {
        ...
        var n, o = c.accepts[e],
            r = {}, s = /^([\w-]+:)\/\//.test(c.url) ? RegExp.$1 : window.location.protocol,
            t = c.xhr();
...
function(a, b) {
    ...
    a.each(o, function(a, c) {
    ...
    }), g = n + "transform", s[h = n + "transition-property"] = s[i = n + "transition-duration"] = s[j = n + "transition-timing-function"] = s[k = n + "animation-name"] = s[l = n + "animation-duration"] = s[m = n + "animation-timing-function"] = "", a.fx = {
        ...
        if (e === b && (e = .4), a.fx.off && (e = 0), "string" == typeof d) t[k] = d, t[l] = e + "s", t[m] = f || "linear", w = a.fx.animationEnd;
        else {
            p = [];
